...
const SalesAnalytics = () => {
  ...
  const periodOptions = [
    ...
    { value: '1year', label: '?��?�? },
    { value: 'custom', label: '?��?範�?' }
  ];

  const metricOptions = [
    { value: 'revenue', label: '?�收?��?', icon: CurrencyDollarIcon },
    { value: 'orders', label: '訂單?��?', icon: ShoppingBagIcon },
    { value: 'customers', label: '客戶?��?', icon: UsersIcon },
    { value: 'products', label: '?��??��?', icon: ChartBarIcon }
  ];
  ...
  const mockSalesMetrics = {
    totalRevenue: { value: 2580000, trend: 12.5, label: '總�??? },
    totalOrders: { value: 1250, trend: 8.3, label: '總�??? },
    avgOrderValue: { value: 2064, trend: 3.7, label: '平�?訂單?��? },
    conversionRate: { value: 3.2, trend: -1.2, label: '轉�??? },
    totalCustomers: { value: 856, trend: 15.6, label: '總客?�數' },
    repeatCustomers: { value: 342, trend: 22.1, label: '?�購客戶' }
  };

  const mockTopProducts = [
    { id: 1, name: '經典?��??��?', sales: 125, revenue: 156250, growth: 18.5 },
    { id: 2, name: '?�瑰?��???, sales: 98, revenue: 98000, growth: 12.3 },
    { id: 3, name: '?�石?�環套�?', sales: 87, revenue: 217500, growth: 8.7 },
    { id: 4, name: '翡�??�鐲', sales: 65, revenue: 195000, growth: 25.6 },
    { id: 5, name: '?�飾�???, sales: 156, revenue: 62400, growth: -3.2 }
  ];

  const mockSalesChannels = [
    { channel: '官方網�?', revenue: 1548000, percentage: 60.0, growth: 15.2 },
    { channel: '第�??�平??, revenue: 645000, percentage: 25.0, growth: 8.9 },
    { channel: '實�?店面', revenue: 258000, percentage: 10.0, growth: -5.3 },
    { channel: '社群媒�?', revenue: 129000, percentage: 5.0, growth: 28.7 }
  ];
      ...
      <div className="w-full px-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          <div className="mb-4 lg:mb-0">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">?�售?��?</h1>
            <p className="text-gray-600">深度?��??�售?��?，�?察�?業趨?��?機�?</p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            ...
            <div className="h-64 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm">?�售趨勢?�表</p>
                ...
                <div key={product.id} className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-600">
                      <span>?��?: {formatNumber(product.sales)}</span>
                      <span>?�收: {formatCurrency(product.revenue)}</span>
                    </div>
                  </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <h4 className="font-medium text-blue-900 mb-2">?��??�售?�測</h4>
                <div className="flex items-center justify-between">
                  <span className="text-blue-700">?�估?�收</span>
                  <span className="font-bold text-blue-900">{formatCurrency(3200000)}</span>
                </div>
                <div className="flex items-center justify-between mt-1">
                  <span className="text-blue-700">?�估訂單</span>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-green-900">?�末?�售表現?�異</p>
                      <p className="text-xs text-green-700">?�末轉�??��???23%，建議�?強週末促銷活�?</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-orange-900">?��?端�??��??��?</p>
                      <p className="text-xs text-orange-700">?��?端�??��?較�??�端�?15%，�??��?行�?體�?</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-purple-900">客戶?�購?��???/p>
                      <p className="text-xs text-purple-700">?�客?��?購�?較�??��???8.5%，客?��?誠度?��?</p>
                    </div>
                  </div>
                </div>
              </div>
