        ...
        <div className="bg-white/40 backdrop-blur-sm rounded-lg p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2 font-chinese">語言</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2 font-chinese">時區</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2 font-chinese">貨幣</label>
                <select
