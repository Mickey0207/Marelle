...
const mockSKUs = [
  { sku: 'TSHIRT-001-WH-M', name: '經典T???�色/M', barcode: '1234567890123' },
  { sku: 'BOTTLE-001', name: '分析水壺', barcode: '9876543210987' }
];
  ...
  return (
    <div className="glass rounded-2xl p-6">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-bold font-chinese">條碼/QR Code 管分析</h2>
      </div>
      <div className="mb-4 flex items-center space-x-2">
        <MagnifyingGlassIcon className="w-5 h-5 text-gray-400" />
        <input
          className="input flex-1"
          placeholder="輸入SKU分析碼分析?�稱分析..."
          value={search}
