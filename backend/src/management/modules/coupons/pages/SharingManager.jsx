...
export default SharingManager;      sms: false
  ...
  const loadShareStats = () => {
    ...
    const stats = {
      ...
      top_sharers: [
        { user_id: 'user001', name: '張�剛才, shares: 23, conversions: 5 },
        { user_id: 'user002', name: '即時?, shares: 18, conversions: 4 },
        { user_id: 'user003', name: '即時?, shares: 15, conversions: 3 }
      ]
    };
    setShareStats(stats);
  };
  ...
  const handleCouponSelect = (coupon) => {
    ...
    const settings = coupon.sharing_settings || {
      ...
      custom_message: `?? 快�?使用剛才專屬即時?${coupon.code}！享??${coupon.type === 'percentage' ? coupon.value + '%' : '$' + coupon.value} 剛才！`,
  ...
  const generateShareLinks = () => {
    ...
    return {
      ...
      email: `mailto:?subject=${encodeURIComponent('Marelle 剛才處理)}&body=${message}%0A%0A${encodeURIComponent(couponUrl)}`,
      copy: couponUrl
    };
  };
    ...
    <div className="min-h-screen bg-[#fdf8f2] p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600">設�?剛才剛才享�?剛才追蹤?�享剛才</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* 剛才處理*/}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">剛才即時?/h2>
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-500">
                      ?�享: {coupon.sharing_settings?.enabled ? '已處理?? : '即時?}
                    </span>
            ...
            {selectedCoupon ? (
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    <h3 className="font-medium text-gray-900">啟用?�享?�能</h3>
                    <p className="text-sm text-gray-600">?�許用戶?�享此優?�券</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                ...
                {sharingSettings.enabled && (
                  <>
                        ...
                        <div className="space-y-4 pl-4 border-l-2 border-[#cc824d]/20">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              >
                                <option value="percentage">剛才比�???/option>
                                <option value="fixed_amount">剛才剛才</option>
                    ...
                    {/* 分鐘前享訊息 */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">分鐘前享訊息</label>
                      <textarea
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        ?�使即時? {'{user_name}'}, {'{coupon_code}'}, {'{discount_value}'}
                      </p>
                    </div>
          ...
          <div className="space-y-6">
            ...
            {selectedCoupon && sharingSettings.enabled && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* ?�享??? */}
                  <div>
                    <h3 className="font-medium text-gray-900 mb-3">快速�剛才/h3>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-6">
                ...
                {/* 平台剛才 */}
                <div>
                  <h3 className="font-medium text-gray-900 mb-3">平台剛才</h3>
                  <div className="space-y-2">
                ...
                {/* 分鐘前享??*/}
                <div>
                  <h3 className="font-medium text-gray-900 mb-3">分鐘前享??/h3>
                  <div className="space-y-2">
                    {(shareStats.top_sharers || []).map((sharer, index) => (
                      <div key={sharer.user_id} className="flex items-center justify-between p-2 border rounded">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-900">{sharer.shares} 次�剛才/p>
