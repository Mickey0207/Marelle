...
const ProductVariantManager = ({ variants, setVariants, onSKUGenerate }) => {
  ...
  const handleDeleteLevel = (levelId) => {
    if (confirm('確分析要刪?�這個分析體層級分析？這分析?�影分析?�相分析SKU??)) {
  ...
  return (
    <div className="variant-manager space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900 font-chinese">變分析管分析</h3>
        <button
          type="button"
          ...
          <div key={variant.id} className="glass rounded-lg p-4">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-medium text-gray-900 font-chinese">
                第{variant.level}層分析{variant.levelName['zh-TW']} / {variant.levelName['en']}
              </h4>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 font-chinese">
                    層分析?�稱 (中分析) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 font-chinese">
                    層分析?�稱 (分析) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-medium text-gray-900 font-chinese">變分析分析</h4>
                  <button
                    type="button"
