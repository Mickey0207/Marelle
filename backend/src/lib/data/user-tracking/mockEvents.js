// 產生 mock 事件資料
const EVENT_TYPES = ['page_view', 'product_view', 'add_to_cart', 'checkout_start', 'purchase', 'search', 'custom'];
const SOURCES = ['direct', 'google', 'facebook', 'line', 'newsletter'];
...
export const EVENT_DICTIONARY = EVENT_TYPES;
export const SOURCE_OPTIONS = SOURCES;
export const DEVICE_OPTIONS = DEVICES;
