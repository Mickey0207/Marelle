        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">總設定項目</p>
                <p className="text-2xl font-bold text-gray-900">{statistics.totalSettings || 0}</p>
              </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">啟用設定</p>
                <p className="text-2xl font-bold text-gray-900">{statistics.activeSettings || 0}</p>
              </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">設定分類</p>
                <p className="text-2xl font-bold text-gray-900">{statistics.totalCategories || 0}</p>
              </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">系統設定</p>
                <p className="text-2xl font-bold text-gray-900">{statistics.systemSettings || 0}</p>
              </div>
