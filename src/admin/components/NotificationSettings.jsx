      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">管理系統通知服務和訊息發送設定</p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">正常運作</p>
              </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          ...
          <div className="space-y-2 text-sm text-blue-800">
            <p>• <strong>郵件通知</strong>：用於發送訂單確認、密碼重設等重要通知</p>
            <p>• <strong>SMTP 設定</strong>：配置郵件發送伺服器，建議使用專業的郵件服務</p>
            <p>• <strong>簡訊通知</strong>：用於即時重要訊息，如驗證碼、緊急通知</p>
            <p>• <strong>測試功能</strong>：建議設定完成後先執行測試確保服務正常</p>
            <p>• <strong>安全提醒</strong>：SMTP 密碼等敏感資訊會以加密方式儲存</p>
          </div>
        </div>
      </div>
    </div>
