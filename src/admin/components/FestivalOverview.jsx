        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <CalendarIcon className="h-8 w-8 text-[#cc824d]" />
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">總節慶數量</p>
                <p className="text-2xl font-bold text-gray-900">{overallStats.totalFestivals}</p>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center text-sm text-gray-600">
                <span className="text-green-600 font-medium">+{overallStats.activeFestivals}</span>
                <span className="ml-1">個進行中</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">總參與人次</p>
                <p className="text-2xl font-bold text-gray-900">{overallStats.totalParticipation?.toLocaleString()}</p>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center text-sm text-gray-600">
                <span className="text-blue-600 font-medium">{overallStats.avgConversionRate?.toFixed(1)}%</span>
                <span className="ml-1">平均轉換率</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">活躍促銷</p>
                <p className="text-2xl font-bold text-gray-900">{overallStats.activePromotions}</p>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center text-sm text-gray-600">
                <TicketIcon className="h-4 w-4 text-purple-500 mr-1" />
                <span>{overallStats.activeCoupons}</span>
                <span className="ml-1">優惠券</span>
              </div>
            </div>
          </div>
        </div>
