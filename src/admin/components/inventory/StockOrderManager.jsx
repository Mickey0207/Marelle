...
const mockOrders = [
  ...
  { id: 2, type: 'out', warehouse: '主倉庫', sku: 'BOTTLE-001', qty: 2, date: '2025-09-15', note: '出貨' }
];
    ...
    <div className="glass rounded-2xl p-6">
      <div className="flex items-center mb-4 justify-between">
        <div className="flex items-center">
          ...
          <h2 className="text-xl font-bold font-chinese">庫存單據管理</h2>
        </div>
        <button className="btn-primary flex items-center" onClick={openForm}><PlusIcon className="w-5 h-5 mr-1" />新增單據</button>
      </div>
      <div className="overflow-x-auto mb-6">
        <table className="w-full">
          <thead className="bg-gradient-to-r from-[#cc824d] to-[#b3723f] text-white">
            <tr>
              <th className="px-6 py-4 text-left text-sm font-semibold font-chinese">單據類型</th>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold font-chinese">備註</th>
            </tr>
          </thead>
