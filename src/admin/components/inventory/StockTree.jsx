...
const mockData = [
  {
    ...
    sku: 'TSHIRT-001',
    variants: [
      { id: 11, type: 'variant', name: '白色/M', sku: 'TSHIRT-001-WH-M', stock: 30 },
      { id: 12, type: 'variant', name: '黑色/L', sku: 'TSHIRT-001-BK-L', stock: 12 }
    ],
    gifts: [
      { id: 21, type: 'gift', name: '品牌貼紙', sku: 'GIFT-001', stock: 100 }
    ],
    stock: 42 // 變體自動加總
  },
  {
  ...
  return (
    <div className="glass rounded-2xl p-6">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-bold font-chinese">商品/贈品庫存</h2>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-gradient-to-r from-[#cc824d] to-[#b3723f] text-white">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold font-chinese">庫存</th>
            </tr>
          </thead>
              ...
              <React.Fragment key={item.id}>
                <tr className="hover:bg-white/30">
                  <td className="px-6 py-4 font-chinese">
                    <button className="mr-2" onClick={() => toggle(item.id)} aria-label="展開/收合">
