      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">行銷管理總覽</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4 flex-1">
                <p className="text-sm font-medium text-gray-500">總曝光數</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">進行中檔期活動</h2>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">平台廣告表現</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">受眾洞察</h2>
              <UserGroupIcon className="h-6 w-6 text-[#cc824d]" />
            </div>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">總受眾數</span>
                <span className="font-semibold">{analytics.audienceInsights?.totalAudiences || 0}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">平均受眾規模</span>
                <span className="font-semibold">
                  {formatNumber(analytics.audienceInsights?.averageAudienceSize)}
                </span>
              </div>
              <div className="border-t pt-4">
                <p className="text-sm font-medium text-gray-700 mb-2">最佳表現受眾</p>
                <p className="text-sm text-gray-900">
                  {analytics.audienceInsights?.topPerformingAudience?.name || '暫無數據'}
                </p>
                <p className="text-sm text-gray-500">
                  收入: {formatCurrency(analytics.audienceInsights?.topPerformingAudience?.performance?.totalRevenue || 0)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">自動化表現</h2>
              <CogIcon className="h-6 w-6 text-[#cc824d]" />
            </div>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">啟用規則</span>
              ...
              <div className="border-t pt-4">
                <p className="text-sm text-gray-600">自動化收入</p>
                <p className="text-lg font-semibold text-gray-900">
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">預算使用狀況</h2>
        ...
        <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <span className="text-sm font-medium">建立檔期</span>
            </button>
            <button className="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <ChartBarIcon className="h-6 w-6 text-[#cc824d] mr-2" />
              <span className="text-sm font-medium">廣告投放</span>
            </button>
            <button className="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <UserGroupIcon className="h-6 w-6 text-[#cc824d] mr-2" />
              <span className="text-sm font-medium">受眾分析</span>
            </button>
            <button className="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <CogIcon className="h-6 w-6 text-[#cc824d] mr-2" />
              <span className="text-sm font-medium">自動化設定</span>
            </button>
          </div>
        </div>
      </div>
