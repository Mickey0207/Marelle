    ...
    <div className="min-h-screen bg-[#fdf8f2] p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">?��?規�?管�?</h1>
          <p className="text-gray-600">管�??��??��??��??��?測試?��??��?</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-gray-500">
                      ?��?: {coupon.stacking_rules?.can_stack ? '?�許' : '不�?�?}
                    </span>
                    {coupon.stacking_rules?.can_stack && (
                      <span className="text-xs text-[#cc824d]">
                        ?��?�? {coupon.stacking_rules.priority}
                      </span>
                    )}
                  </div>
                </div>
          ...
          {/* ?��?規�?設�? */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">?��?規�?設�?</h2>
                ...
                <div>
                  ...
                  {stackingRules.can_stack && (
                    <div className="space-y-4 pl-6 border-l-2 border-[#cc824d]/20">
                      ...
                      {/* ?��?規�? */}
                      <div>
                        <h4 className="font-medium text-gray-700 mb-3">?��??��?規�?</h4>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-gray-900">?��?測試</h2>
              <button
                onClick={runAllTests}
              ...
              {testingScenarios.map(scenario => (
                <div key={scenario.id} className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-500">
                    訂單?��?: ${scenario.order_value} | ?��?: {scenario.expected_result}
                  </p>
                </div>
              ))}
            </div>
