      ...
      <div className="glass rounded-2xl p-6">
            ...
            <div key={variant.id} className="border border-gray-200 rounded-xl p-4 bg-white/50">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-4 flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="ËÆäÈ??çÁ®± (‰æãÂ?: È°èËâ≤?ÅÂ∞∫ÂØ?"
        ...
        {variants.length === 0 && (
          <div className="text-center py-8 text-gray-500 font-chinese">
            ...
            <p>Â∞öÊú™Ë®≠Â?‰ªª‰?ËÆäÈ?Â±¨ÊÄ?/p>
            <p className="text-sm">ÈªûÊ?‰∏äÊñπ?âÈ??ãÂ??∞Â?ËÆäÈ?Â±¨ÊÄ?/p>
          </div>
        )}
      </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold font-chinese flex items-center">
              ...
              <span className="ml-2 text-sm font-normal text-gray-500">
                ({skuCombinations.length} ?ãÁ???
              </span>
            </h3>
            <div className="flex items-center space-x-2">
              <span className="text-sm text-gray-500 font-chinese">?πÈ??ç‰?:</span>
              <button
                type="button"
                onClick={() => {
                  const price = prompt('Ë´ãËº∏?•Ë?Â•óÁî®?∞Ê??âSKU?ÑÊ??¨ÂÉπ:');
              ...
              <button
                type="button"
                onClick={() => {
                  const price = prompt('Ë´ãËº∏?•Ë?Â•óÁî®?∞Ê??âSKU?ÑÂîÆ??');
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-[#cc824d] to-[#b3723f] text-white">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">ËÆäÈ?ÁµÑÂ?</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">?êÊú¨??/th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">?üÂÉπ</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">?ÆÂÉπ</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">?ÖÂç°??/th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">?Ä?°ÂÉπ</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">?ëÂç°??/th>
                  <th className="px-4 py-3 text-left text-sm font-semibold font-chinese">Â∫´Â?</th>
                </tr>
              </thead>
