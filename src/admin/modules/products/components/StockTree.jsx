...
const mockData = [
  {
    ...
    sku: 'TSHIRT-001',
    variants: [
      { id: 11, type: 'variant', name: '?½è‰²/M', sku: 'TSHIRT-001-WH-M', stock: 30 },
      { id: 12, type: 'variant', name: 'é»‘è‰²/L', sku: 'TSHIRT-001-BK-L', stock: 12 }
    ],
    gifts: [
      { id: 21, type: 'gift', name: '?ç?è²¼ç?', sku: 'GIFT-001', stock: 100 }
    ],
    stock: 42 // è®Šé??ªå?? ç¸½
  },
  {
  ...
  return (
    <div className="glass rounded-2xl p-6">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-bold font-chinese">?†å?/è´ˆå?åº«å?</h2>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-gradient-to-r from-[#cc824d] to-[#b3723f] text-white">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold font-chinese">åº«å?</th>
            </tr>
          </thead>
              ...
              <React.Fragment key={item.id}>
                <tr className="hover:bg-white/30">
                  <td className="px-6 py-4 font-chinese">
                    <button className="mr-2" onClick={() => toggle(item.id)} aria-label="å±•é?/?¶å?">
